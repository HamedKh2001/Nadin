...
using Nadin.Application.Features.AuthenticationFeature.Commands.ChangeUsersPassword;
...
using Nadin.WebAPI.Controllers.V1;
using SharedKernel.Common;
using System.Security.Claims;
using Xunit;

namespace Nadin.WebAPI.UnitTests.Controllers.V1
{
