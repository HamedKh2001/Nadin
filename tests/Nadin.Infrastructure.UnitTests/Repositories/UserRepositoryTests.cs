...
namespace Nadin.Infrastructure.UnitTests.Repositories
{
    public class UserRepositoryTests
    {
        ...
        private void SeedDatabase(NadinDbContext context)
        {
            var user1 = new User
            {
                UserName = "user1",
        ...
        private (NadinDbContext dbContext, UserRepository groupRepository) GetContextAndUserRepository()
        {
            var options = new DbContextOptionsBuilder<NadinDbContext>()
                .UseInMemoryDatabase(databaseName: Guid.NewGuid().ToString())
                .Options;

            var context = new NadinDbContext(options);
