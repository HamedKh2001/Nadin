...
namespace Nadin.Application.UnitTests.Features.RoleFeature.Commands
{
    public class UpdateRoleCommandHandlerTests
    {
        ...
        public UpdateRoleCommandHandlerTests()
        {
            ...
            _handler = new UpdateRoleCommandHandler(
                _mockRoleRepository.Object, _mapper);
        }
        ...
        public async Task Handle_WhenRoleExists_ShouldUpdateRoleAndReturnUnit()
        {
            ...
            // Assert
            _mockRoleRepository.Verify(x => x.UpdateAsync(existingRole, CancellationToken.None), Times.Once);
