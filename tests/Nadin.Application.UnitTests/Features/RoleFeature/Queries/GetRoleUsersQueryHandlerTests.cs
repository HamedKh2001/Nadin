...
namespace Nadin.Application.UnitTests.Features.RoleFeature.Queries
{
    public class GetRoleUsersQueryHandlerTests
    {
        ...
        public async Task Handle_WithRoleId_ReturnsMappedDto()
        {
            ...
            var role = new Role
            {
                ...
                Title = "Title",
                Groups = new List<Group> { new Group { Id = 1, Caption = "Group1", Users = new List<User> { new User { Id = 1, FirstName = "User1" } } } }
            };
            var query = new GetRoleUsersQuery { RoleId = roleId };
            var mappedDto = new GetRoleUsersDto { GroupId = 1, GroupCaption = "Group1", Users = new List<UserDto> { new UserDto { Id = 1, FirstName = "User1" } } };
            ...
            Assert.Collection(dto.Users, user =>
            {
                ...
                Assert.Equal(mappedDto.Users[0].FirstName, user.FirstName);
            });
        }
